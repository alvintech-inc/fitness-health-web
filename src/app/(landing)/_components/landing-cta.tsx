    ...
    return (
        <section className="relative overflow-hidden border-t border-border/50 bg-background py-24 sm:py-32">
            <div className="pointer-events-none absolute inset-0">
                ...
                <div className="absolute right-16 bottom-0 h-48 w-48 rounded-full bg-emerald-400/8 blur-3xl" />
            </div>
                ...
                <div className="space-y-8">
                    <div className="space-y-5">
                        ...
                        <p className="mx-auto max-w-2xl text-lg leading-8 text-muted-foreground">
                            Join thousands of people using Responsibly to track their steps, sleep, calories, and workouts — and actually build habits that stick.
                        </p>
                    </div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Free forever · No setup fees · Upgrade anytime
                    </p>
                </div>
            </div>
        </section>
